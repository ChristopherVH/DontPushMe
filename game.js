...
//
//     if ((mybottom - this.speeddown < othertop) ||
//            (mytop + this.speedup > otherbottom + otherobj.speed) ||
//            (myright < otherleft + this.speedright) ||
//            (myleft + this.speedleft > otherright)) {
//        crash = false;
//     }
//     // var crash = false;
//     // if (((myright >= otherleft && myleft <= otherleft && ((mybottom >= othertop && mybottom <= otherbottom) || (mytop <= otherbottom && mytop >= othertop) || (mytop > othertop && mybottom < otherbottom) || (mytop < othertop && mybottom > otherbottom))) ||
//     // (myleft <= otherright && myright >= otherright && ((mybottom >= othertop && mybottom <= otherbottom) || (mytop <= otherbottom && mytop >= othertop) || (mytop > othertop && mybottom < otherbottom) || (mytop < othertop && mybottom > otherbottom))))){
//     //       crash = true;
//     // }
//     // ||
//     // (mybottom >= othertop && mytop >= othertop && (myleft <= otherleft || myright >= otherright)) || (mytop <= otherbottom && mybottom <= otherbottom && (myleft <= otherleft || myright >= otherright))
//
//     // if ((mybottom  < othertop + otherobj.speeddown) ||
//     //        (mytop + this.speed > otherbottom + otherobj.speedup) ||
//     //        (myright < otherleft + otherobj.speedright) ||
//     //        (myleft + otherobj.speedleft > otherright)) {
//     //    crash = false;
//     // }
//     if (crash){
//       this.xmove = 0;
...
//           //4
//         }else{
//           this.ymove = otherbottom - mytop - this.speedup + otherobj.speed;
//           this.moveup = 0;
//           //8
//         }
//       }
...
//             this.xmove = 0;
//             this.movedown = 0;
//             this.speeddown = this.speeddown * 2;
//           }else{
//             this.ymove = 0;
//             this.moveright = 0;
//             this.speeddown = this.speeddown * 2;
...
//     }
//     if (everyinterval(400)){
//       myGameArea.times = 0;//TODO change back to +=1
//     }
//     if( myGamePiece.die()){
//       myGameArea.stop();
//     }
...
//         if (myObstacles[i].crashWith(myObstacles[j])){
//           // if(myObstacles[i].ymove < 0){
//           //   myObstacles[i].y = myObstacles[j].y + myObstacles[i].ymove;
//           //   myObstacles[i].speed = myObstacles[j].speed;
//           // }
//         }
//       }
...
//             myGamePiece.crashNumb +=1;
//           }
//           if (myGamePiece.crashLeft && myGamePiece.crashUp){
//             myGamePiece.ymove = 0;
//           }
//           if (myGamePiece.crashRight && myGamePiece.crashUp){
//             myGamePiece.ymove = 0;
//           }
//           console.log(myGamePiece.crashUp);
//           // console.log(myGamePiece.crashDown);
//           // console.log(myGamePiece.crashLeft);
//           // console.log(myGamePiece.crashRight);
//           console.log(myGamePiece.crashNumb);
//           // console.log(myGamePiece.xmove);
//           // console.log(myGamePiece.ymove);
//
//
...
//         }
//     }
//     if ((myGamePiece.crashUp && myGamePiece.crashDown) && !(myGamePiece.crashLeft && myGamePiece.crashRight) && (myGamePiece.crashNumb < 3)){
//       myGameArea.stop();
//     }
//     myGameArea.clear();
//
